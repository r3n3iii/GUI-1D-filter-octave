...
function handles = build_plot_panel(parent)
  ...
  title(handles.ax_mag, 'Magnitude Response', 'FontSize', TITLE_SIZE);
  ...
  title(handles.ax_pz, 'Pole-Zero Plot', 'FontSize', TITLE_SIZE);
  ...
  title(handles.ax_imp, 'Impulse Response', 'FontSize', TITLE_SIZE);
